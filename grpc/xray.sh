...
#
wget -q -O /usr/local/bin/geosite.dat "https://raw.githubusercontent.com/amirulckck/test/main/grpc/geosite.dat"
wget -q -O /usr/local/bin/geoip.dat "https://raw.githubusercontent.com/amirulckck/test/main/grpc/geoip.dat"
