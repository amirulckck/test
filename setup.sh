...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/ip > /root/tmp
...
# https://raw.githubusercontent.com/amirulckck/prem/main/ijin 
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
rm ssh-vpn.sh
clear
#
#Instal Xray
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/sstp/sstp.sh && chmod +x sstp.sh && ./sstp.sh
rm sstp.sh
clear
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/wireguard/wg.sh && chmod +x wg.sh && ./wg.sh
rm wg.sh
clear
#Instal UDP & Slow Dns
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
rm udp.sh
clear
#Instal UDP & Slow Dns
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/amirulckck/test/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
rm set-br.sh
clear
#Instal menu
echo -e "\e[33m-----------------------------------\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/.ver )
