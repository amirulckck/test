...
Isadmin=$(curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/ijin | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
rm /root/vpnpremium
rm /opt/.ver
version_up=$(curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/versi)
...
serverV=$(curl -sS https://raw.githubusercontent.com/amirulckck/prem/main/versi)
if [ "$Isadmin" = "ON" ]; then
